  ...
  <v-app app>
    <v-app-bar app class="white" height="20">
       <v-app-bar-nav-icon 
          ...
          ></v-app-bar-nav-icon>
        <v-toolbar-title  class="mt-10"><b style="font-family:serif;">HAWALAT AL IMAN</b></v-toolbar-title>
        ...
        <template v-slot:extension>
          ...
          <v-tabs
            ...
            id="tabs_nav"
          >
            <tab><router-link to="/"><v-icon color="primary" class="main-link">mdi-home</v-icon>HOME</router-link></tab>
            <tab><router-link to="/amakuru"><v-icon color="primary" class="main-link">mdi-newspaper</v-icon>ABOUT</router-link></tab>
            <tab><router-link to="/serivise"><v-icon color="primary" class="main-link">mdi-wrench</v-icon>ACTIVITY</router-link></tab>
            <tab><router-link to="/complain"><v-icon color="primary" class="main-links">mdi-image</v-icon>GALLARY</router-link></tab>
            <tab><router-link to="/abakozi"><v-icon color="primary" class="main-link">mdi-account-group</v-icon>MUSLIMS</router-link></tab>
            <tab><router-link to="/abakozi"><v-icon color="primary" class="main-link">mdi-phone</v-icon>CONTACT</router-link></tab>
            <tab style="display:relative;margin-left:50px;"><router-link to="/login"><v-icon color="primary" class="main-link">mdi-lock</v-icon>LOGIN</router-link></tab>
          </v-tabs>
        </template>
    </v-app-bar>
